  ...
  return (
    <div className="backdrop">
      <section className="StartScreen">
        ...
        <nav>
          <NavLink className="btn-default start-btn" to="/new">START NEW GAME</NavLink>
          <NavLink className="btn-default start-btn" to="/join">JOIN GAME</NavLink>
          <NavLink className="btn-default start-btn" to="/rules">VIEW RULE LIST</NavLink>
        </nav>
      </section>
    </div>
  )
